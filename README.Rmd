...
sticker(expression({plot.new(); text(0.5, 0.5, "p", font=2 ,cex = 9, col = scales::alpha("#0091b6", 0.35))}),
        package="personalized",
        p_size=6, s_x=0.8, s_y=.75, s_width=1.3, s_height=1,
        p_y = 1.35,
        h_color = scales::alpha(unname(jcolors()[2]), 0.75),
        h_fill = scales::alpha(unname(jcolors()[2]), 1),
        filename="vignettes/sticker.png")
```
